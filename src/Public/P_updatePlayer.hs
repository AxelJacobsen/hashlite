...
increaseMaxHp inPlayer change = Player      (name inPlayer) (maxHp inPlayer+change) (hp inPlayer) (weapon inPlayer) (armour inPlayer) (healpot inPlayer) (money inPlayer) (lowestLayer inPlayer) (playerPos inPlayer) (goal inPlayer) (start inPlayer) (prevDir inPlayer) (pExp inPlayer) (levelCap inPlayer)
...
updateWeapon inPlayer change = Player       (name inPlayer) (maxHp inPlayer) (hp inPlayer) (weapon inPlayer+change) (armour inPlayer) (healpot inPlayer) (money inPlayer) (lowestLayer inPlayer) (playerPos inPlayer) (goal inPlayer) (start inPlayer) (prevDir inPlayer) (pExp inPlayer) (levelCap inPlayer)

updateArmour :: Player -> Int -> Player
updateArmour inPlayer change = Player       (name inPlayer) (maxHp inPlayer) (hp inPlayer) (weapon inPlayer) (armour inPlayer+change) (healpot inPlayer) (money inPlayer) (lowestLayer inPlayer) (playerPos inPlayer) (goal inPlayer) (start inPlayer) (prevDir inPlayer) (pExp inPlayer) (levelCap inPlayer)
...
newLayer inPlayer (sX,sY) (gX,gY) = Player  (name inPlayer) (maxHp inPlayer+1) (hp inPlayer+1) (weapon inPlayer) (armour inPlayer) (healpot inPlayer) (money inPlayer) (lowestLayer inPlayer+1) (sX,sY) (gX,gY) (sX,sY) (prevDir inPlayer) (pExp inPlayer) (levelCap inPlayer)
